...
function FileUploader() {
    ...
    return (
        <div className="flex flex-col gap-2">
            <label htmlFor="file" className="cursor-pointer text-text-head text-base font-medium px-2">إرفاق المرفقات</label>
            <input ref={fileInputRef}
                onChange={handleFileChange} accept="application/pdf" type="file" id="file" className="hidden" />
